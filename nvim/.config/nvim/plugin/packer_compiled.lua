...
_G.packer_plugins = {
  ...
  ["git.nvim"] = {
    loaded = true,
    path = "/home/michael/.local/share/nvim/site/pack/packer/start/git.nvim",
  ...
  ["lspsaga.nvim"] = {
    ...
    loaded = true,
    path = "/home/michael/.local/share/nvim/site/pack/packer/start/lspsaga.nvim",
  ...
  ["nvim-bufferline.lua"] = {
    loaded = true,
    path = "/home/michael/.local/share/nvim/site/pack/packer/start/nvim-bufferline.lua",
  ...
  ["telescope-file-browser.nvim"] = {
    loaded = true,
    path = "/home/michael/.local/share/nvim/site/pack/packer/start/telescope-file-browser.nvim",
